...
final class LiveKitVoiceSource: NSObject, VoiceSource, RoomDelegate, @unchecked Sendable {
    ...
    public func onStateChange(_ cb: @escaping (AgentState) -> Void) { tracker.onState = cb }
...
enum LiveKitVoiceSourceError: Error, Equatable {
