...
```kotlin
implementation("dev.sinua:sinua-core:0.1.0-beta.4")
implementation("dev.sinua:sinua-view:0.1.0-beta.4")
implementation("dev.sinua:sinua-gemini:0.1.0-beta.4")   // only the vendors you use
```
